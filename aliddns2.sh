...
# sunup, modified 27/1/2023
# 在 N1 debian Buster with Armbian Linux 5.3.0-aml-g12 手动执行/定时任务(crontab)执行测试通过
# 2021-11-05 修改 支持@ 和*域名的处理，增加对群晖6.22的bug的修改并测试通过。by sunup
# 2021-11-05 增加日志功能
#================================================================================================================#
#
# 使用方法：
...
aliddns_iptype='' # 'A' 或 'AAAA'，代表ipv4 和 ipv6
...
mdate=$(date "+%Y-%m-%d")
#日志的存放路径改为自己
logPath="/home/aliddns/log/ALIDDNS-$mdate.log"
debug_flag="0"
#--------------------------------------------------------------
machine_ip=""
ddns_ip=""
